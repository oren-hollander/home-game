...
export const getSignedInUser: Selector<State, User> = state => ({ name: state.auth.name, userId: state.auth.userId })
export const getSignedInUserEmail: Selector<State, string> = state => state.auth.email
