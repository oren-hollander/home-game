import {
  groupHostedGamePlayersByInvitationStatus,
  groupInvitedGamePlayersByInvitationStatus,
...
describe('player lists', () => {
  ...
  describe('invited game player lists', () => {
    ...
    const playerIds = [Approved1, Approved2, Declined1, Declined2, StandBy1, StandBy2, NoResponse1, NoResponse2]
    ...
    beforeEach(() => {
      ...
      playerLists = groupInvitedGamePlayersByInvitationStatus(players, [
        InvitationResponse(Approved1, 'approved'),
        InvitationResponse(Approved2, 'approved'),
        InvitationResponse(Declined1, 'declined'),
        InvitationResponse(Declined2, 'declined'),
