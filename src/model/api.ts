// import {Game, InvitationStatus, Invitation, User} from './types'
...
//   updateInvitationStatus(playerId: string, gameId: string, status: InvitationStatus): Promise<void>
//   getInvitation(playerId: string, gameId: string): Promise<Invitation | undefined>
